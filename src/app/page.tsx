  ...
  return (
    <AppShell>
      <section className="mx-auto flex max-w-5xl flex-col px-4 py-8 sm:px-6 sm:py-12">
        ...
        {/* Ações rápidas */}
        <div className="mb-10 grid grid-cols-2 gap-3 sm:flex sm:flex-wrap animate-fade-in-delay-1">
          <Link
          ...
          <Link
            href="/equipamentos"
            className="col-span-2 inline-flex items-center justify-center gap-2 rounded-xl border border-slate-700 bg-slate-800/50 px-4 py-3 text-sm font-medium text-slate-300 transition-all hover:bg-slate-700/50 active:scale-95 sm:col-auto sm:hover:scale-105"
          >
            <svg className="h-4 w-4 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
              <path strokeLinecap="round" strokeLinejoin="round" d="M2.036 12.322a1.012 1.012 0 010-.639C3.423 7.51 7.36 4.5 12 4.5c4.638 0 8.573 3.007 9.963 7.178.07.207.07.431 0 .639C20.577 16.49 16.64 19.5 12 19.5c-4.638 0-8.573-3.007-9.963-7.178z" />
              <path strokeLinecap="round" strokeLinejoin="round" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
            </svg>
            <span className="truncate">Ver Equipamentos</span>
          </Link>
        </div>
